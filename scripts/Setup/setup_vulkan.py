...
class VulkanConfiguration:
    requiredVulkanVersion = "1.3.216.0" # TODO: Would be better to have a min version like 1.3. but the download url would not work
    vulkanDirectory = "./GitGud/vendor/VulkanSDK"
    ...
    def CheckVulkanSDK(cls):
        return True
        # TODO: For some reason environ cannot find VULKAN_SDK although it's set
        """
